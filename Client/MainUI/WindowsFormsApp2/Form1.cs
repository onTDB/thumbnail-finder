...
namespace WindowsFormsApp2
{
    ...
    public partial class Form1 : Form
    {
        ...
        public void DownImg(string p_id)
        {
            try
            {
                WebClient webclient = new WebClient();
                if (!System.IO.File.Exists(DownImgPath))               
                {
                    webclient.DownloadFile(returnThumbnailurl, DownImgPath+@"\"+p_id+@".jpg");
                }
                                ...
                                try
                                {
                                    while (true)
                                    {
                                        ...
                                        if (rtn1["status"].ToString() == "200")
                                        {
                                            ...
                                            //lbl_Title.Text = "분석 완료 :" + rtn1["data"]["timestampMinSec"].ToString();
                                            break;
                                        }
